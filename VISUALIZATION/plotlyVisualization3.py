...
def visualization(pathToInputFile,  mln_User,mappingInputFile):
    ...
    fig.write_html(os.path.join(endPath,"visualization",f"{clusterName}_network_plotly.html"))
    fpath = os.path.join(mln_User,"visualization",f"{clusterName}_network_plotly.html")
    return fpath
